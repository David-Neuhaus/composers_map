...
import ComposerLocation from "@/app/ui/database/composer-locations";
    ...
    <main className="p-8">
      ...
      <div className="grid grid-cols-3">
        <div className="col-span-1">
          <ComposerLocation composer={composer}></ComposerLocation>
          <AddLocation id={params.id} cities={cities}></AddLocation>
        </div>
